...
#        current_node.is_leaf = True
#        return
    while not (node_list[current_node.left_child_id].is_pruned and 
                node_list[current_node.right_child_id].is_pruned):
...
#    print('PE:', subtree_pessimistic_error)
    if((subtree_expectation <= node_expectation) and (current_node.identifier != 0)):
...
print('The test data is used for determining the accuracy using heuristic based pruning')
print('-------------------------------------------------------------------')
